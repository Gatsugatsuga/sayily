  ...
  return (
    <>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Instrument+Serif&family=Instrument+Sans:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </Head>
      ...
      <main className={styles.page}>
        ...
        <div className={styles.socialHeader}>
          <a href="https://warpcast.com/calledtosayily" target="_blank" className={styles.icon}>
            FARCASTER
          </a>
          <a href="https://bsky.app/profile/sayily.bsky.social" target="_blank" className={styles.icon}>
            BLUESKY
          </a>
          <a href="https://hey.xyz/u/sayily" target="_blank" className={styles.icon}>
            LENS
          </a>
          <a href="https://x.com/sayILYart" target="_blank" className={styles.icon}>
            X
          </a>
        </div>
