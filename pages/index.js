...
<div className="mt-8 text-lg">
  <a href="https://warpcast.com/calledtosayily" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline inline-block mx-3">
   // FARCASTER  /  
  </a>
  <a href="https://bsky.app/profile/sayily.bsky.social" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline inline-block mx-3">
   / BLUESKY  /  
  </a>
  <a href="https://hey.xyz/u/sayily" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline inline-block mx-3">
  /  LENS  / 
  </a>
  <a href="https://x.com/sayILYart" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline inline-block mx-3">
  /  X //
  </a>
</div>
